...
def select_player(screen, player_number):
    ...
    selected_FW = pygame.image.load("Assets/Fighters/Fantasy Warrior/Sprites/idle.png")
    selected_FW = pygame.transform.scale(selected_FW, (200, 200))
    selected_wizard = pygame.image.load("Assets/Fighters/EVil Wizard/Sprites/idle.png")
    selected_wizard = pygame.transform.scale(selected_wizard, (200, 200))
    selected_oni_Samurai = pygame.image.load("Assets/Fighters/Oni Samurai/Sprites/idle.png")
    selected_oni_Samurai = pygame.transform.scale(selected_oni_Samurai, (200, 200))
    selected_samurai = pygame.image.load("Assets/Fighters/Samurai/Sprites/idle.png")
    selected_samurai = pygame.transform.scale(selected_samurai, (200, 200))
    selected_MH = pygame.image.load("Assets/Fighters/Martial Hero/Sprites/idle.png")
    selected_MH = pygame.transform.scale(selected_MH, (200, 200))
    selected_Squire = pygame.image.load("Assets/Fighters/Squire/Sprites/idle.png")
    selected_Squire = pygame.transform.scale(selected_Squire, (200, 200))
    selected_Knight = pygame.image.load("Assets/Fighters/Knight/Sprites/idle.png")
    selected_Knight = pygame.transform.scale(selected_Knight, (200, 200))
    selected_Huntress = pygame.image.load("Assets/Fighters/Fantasy Warrior/Sprites/idle.png")
